                        ...
                        <div class="w3pvt-bg">
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="/" class="drop-text">Process</a></li>
                                                ...
                                                <li><a href="/" class="drop-text">Clients</a></li>
                                            </ul>
                                        </li>
                            ...
                            <div class="justify-content-center">
                                ...
                                <div class="apply-w3-pvt ml-lg-3">
                                    <a class="btn read" href="/contact" role="button">Apply Now</a>
                                </div>
                                <!-- //search -->
            ...
            <div class="row">
                ...
                <div class="col-lg-8 single-left">
                    <div class="single-left1">
                        ...
                        <h5 class="card-title">
                            <a href="/single" class="text-bl">Sed ut perspiciatis unde omnis iste.</a>
                        </h5>
                        ...
                        <div class="col-md-6 single-left2-left">
                            <ul>
                                <li class="mt-3">
                                    ...
                                    <a href="/single">At vero eos et accusamus iusto</a>
                                </li>
                                <li class="mt-3">
                                    <span class="fa fa-check mr-2"></span>
                                    <a href="/single">Sed ut perspiciatis unde omnis</a>
                                </li>
                                <li class="mt-3">
                                    <span class="fa fa-check mr-2"></span>
                                    <a href="/single">Accusantium doloremque lauda</a>
                                </li>
                                <li class="mt-3">
                                    <span class="fa fa-check mr-2"></span>
                                    <a href="/single">Vel illum qui dolorem fugiat quo</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6 single-left2-left">
                    ...
                    <div class="event-right1">
                        ...
                        <div class="categories mt-4 p-sm-4 p-3 border">
                            ...
                            <ul>
                                ...
                                <li class="mt-3">
                                    <span class="fa fa-check mr-2"></span>
                                    <a href="/single">Quis autem vel eum repreh</a>
                                </li>
                                <li class="mt-3">
                                    <span class="fa fa-check mr-2"></span>
                                    <a href="/single">Neque porro quisquam est qui</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="posts-grids">
                                <div class="row posts-grid mt-4">
                                    ...
                                    <div class="col-lg-8 col-sm-8 posts-grid-right mt-sm-0 mt-4">
                                        <h4>
                                            <a href="/single" class="text-bl">Sed ut perspiciatis elit in Scelerisque</a>
                                        </h4>
                                ...
                                <div class="row posts-grid mt-4">
                                    ...
                                    <div class="col-lg-8 col-sm-8 posts-grid-right mt-sm-0 mt-4">
                                        <h4>
                                            <a href="/single" class="text-bl">Perspiciatis unde omni elit in Scelerisque</a>
                                        </h4>
                                        <ul class="w3-pvt_courses_events_list mt-2">
                                            <li class="mr-2 text-bl">
                        ...
                        <div class="tags mt-4 p-4 border">
                            ...
                            <ul class="mt-4">
                                <li>
                                    <a href="/about" class="text-bl border">dfre</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">Gahydwq</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">qeers</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">hysert</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">hjwsa</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">sumgr</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">nhyewq</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">njyra</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">laiuwa</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">loghw</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">mhyu</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">mojjs</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">suisq</a>
                                </li>
                                <li>
                                    <a href="/about" class="text-bl border">bhyfgh</a>
                                </li>
                            </ul>
                        </div>
    ...
    <footer class="footer-content py-5">
        <div class="container py-md-3">
            <div class="footer-top text-center">
                <h2>
                    <a class="navbar-brand pt-3 mb-5" href="/">
                ...
                <div class="col-lg-3 col-md-6 mt-lg-0 mt-4">
                    <div class="footer-wthree">
                        ...
                        <ul class="list-info-wthree">
                            ...
                            <li>
                                <a href="/single"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
                                    Single Page
                                </a>
                            </li>
                            <li>
