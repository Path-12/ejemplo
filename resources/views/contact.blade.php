...
<head>
    <title>Repay Net Banking Category Bootstrap Responsive Web Template | Contact :: W3layouts</title>
    <!-- Meta tag Keywords -->
        ...
        <div class="container py-md-5">
            <div class="text-center px-lg-5">
                ...
                <div class="title-desc text-center px-lg-5">
                    <p class="px-lg-5 sub-vj">Praesent ullamcorper dui turpis.At vero eos et accusam et justo duo dolores et ea rebum.Integer sit amet mattis quam, sit amet ultricies velit. Praesent ullamcorper dui turpis.
                        Praesent ullamcorper dui turpis.</p>
                </div>
            </div>
            <div class="contact-w3ls-form mt-5">
                <form action="{{ route('mensajes') }}" class="w3-pvt-contact-fm" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="Subject" placeholder="" required=""></textarea>
                            </div>
                        </div>
