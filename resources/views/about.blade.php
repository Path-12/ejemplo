...
<head>
    <title>Repay Net Banking Category Bootstrap Responsive Web Template | About :: W3layouts</title>
    <!-- Meta tag Keywords -->
...
<body>
    ...
    <!-- //mid-->
    <section class="other_services about pt-5">
        <div class="container py-md-5 py-3">
            <h3 class="title-w3ls mb-5">A wide range of Banking services</h3>
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="grid">
                        <img src="images/banner3.jpg" alt="" class="img-fluid">
                        <div class="info p-4">
                            <h4 class="loan-vj">Personal Banking</h4>
                ...
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="grid">
                        ...
                        <div class="info p-4">
                            <h4 class="loan-vj">Financial Services</h4>
                            <p class="my-3">Onec consequat sapien ut amet leo cursus rhoncus. Nullam dui mi....</p>
                            <a href="#" class="btn read">Read More </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="grid">
                        ...
                        <div class="info p-4">
                            <h4 class="loan-vj">Loan Management</h4>
                            <p class="my-3">Onec consequat sapien ut amet leo cursus rhoncus. Nullam dui mi....</p>
                            <a href="#" class="btn read">Read More </a>
                        </div>
                    </div>
    ...
    <!-- //news-letter -->
    <!-- /services -->
    <div class="welcome py-5" id="team">
        <div class="container py-xl-5 py-lg-3">
            <div class="row">
                <div class="col-lg-7 welcome-right text-center mt-lg-0 mt-5">
                    <div class="row">
                        ...
                        <div class="col-sm-4 service-1-w3pvt serve-gd2">
                            <div class="serve-grid test-gd mt-4">
                                <img src="images/t2.jpg" alt="" class="img-fluid image1">
                                <p class="mt-2">Partner4 </p>
                            </div>
                            <div class="serve-grid test-gd mt-4">
                                <img src="images/t1.jpg" alt="" class="img-fluid image1">
                                <p class="mt-2">Partner5 </p>
                            </div>
                        </div>
                        <div class="col-sm-4 service-1-w3pvt serve-gd1">
                            <div class="serve-grid test-gd mt-4">
                                <img src="images/t4.jpg" alt="" class="img-fluid image1">
                                <p class="mt-2">Partner6 </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-5 welcome-left pl-lg-5">
                    <h4>Amazing </h4>
                    <h3 class="title-w3ls mt-2 mb-3">Partners</h3>
